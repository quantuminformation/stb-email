...
let tableHtmlButtons = tableColumnData.map(data => `
    <td style="border: 2px solid black;"><a href="${data.link}" style="background: linear-gradient(to right, darkred, orange); color: #ffffff; padding: 10px; text-decoration: none;">Button</a></td>`).join('');

let tableHtml = `
  <table style="width: 100%; color: #ffffff; margin: auto; border-collapse: collapse;">
...
let emailHtmlContent = `
  <div style="background-color: #313132; color: #ffffff; padding:1rem">
    <img src="${imageRoot}/STB-Logo-neu_transparent.png" style="width: 12rem; margin-bottom: 1rem; display: block;" alt="Logo"/>
