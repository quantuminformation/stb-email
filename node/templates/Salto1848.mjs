...
<a href='${link}'>
  <img width='30rem' src='${imageRoot}btn_jetzt.png' />
</a>
...
const tableColumnData = [
  ...
  {
    content: `<img width='30rem' src='${imageRoot}175.png' />`,
  },
];
...
let emailHtmlContent = `
  <div style='background-color: #313132; color: #ffffff; font-size: 1.1rem; font-family:Calibri;'>
...
<span style='font-size:11pt'><span ><strong>Schwäbischer Turnerbund e.V.</strong><br>
Fritz-Walter-Weg 19<br>
70372 Stuttgart<br>
Tel: 0711 / 49092 - 0</span></span><br>
<br>
